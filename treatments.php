...
<div class="care_agileits">
	<div class="container">
		...
		$sql_estudios = "SELECT * FROM estudios ORDER BY nombre ASC";
		...
		?>
			...
			<form class="buscador form-inline my-5" action="busqueda.php" method="POST">
				<input name="buscar" class="form-control mr-sm-2" type="search" placeholder="Que estudio buscabas" aria-label="Search">
