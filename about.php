		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="about.html" class="active">Acerca de Nosotros</a></li>
	...
	<div class="container">
		...
		<div class="services-grids w3layouts">
			...
			<div class="col-md-6 ser-left-page">
				...
				<h4><?php echo $general['nombre_laboratorio']?></h4>
							<?php  foreach($principal_informacion as $informacion): ?>
							<p><?php echo $informacion['nosotros_descripcion']?>
							<?php  endforeach ?>
							</p>
							<br>
